...
public class CreateSellerRequestValidator extends AbstractObjectValidator<CreateSellerRequest> {
	public CreateSellerRequestValidator(CreateSellerRequest validatedObject)
	{
